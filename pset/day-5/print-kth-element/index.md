...
- write `mkdir print-kth-element` to create a folder called `print-kth-element`
- write `cd print-kth-element` to go to the `print-kth-element` folder
- write `code print-kth-element.cpp` to create a file called `print-kth-element.cpp` and open it in the editor
...
```bash
check50 iti-technical-team/problemset/pset/5/print-kth-element
```
...
```bash
submit50 iti-technical-team/problemset/pset/5/print-kth-element
```
